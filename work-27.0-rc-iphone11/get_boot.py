...
patch(0x2fd04, 0xd2800020)        # FFFFFFF01702FCB4
patch(0x2fd04+4, 0xd65f03c0)        # FFFFFFF01702FCB8
fp.close()
#create im4p
...
patch(0x2139aa4, 0xd2800000) #mov x0,#0 # __ZN15AppleSEPManager11_didTimeoutEP18IOTimerEventSource
patch(0x2139aa4+4, 0xD65F03C0) # ret
...
patch(0x20e629c, 0xd503201f)    # nop # __ZN23AppleKeyStoreUserClient5startEP9IOService XXX TODO SKIP
# "AppleSEPKeyStore":pid:19,:13899: operation failed (sel: 0 ret: e00002d8) -> make always successful result
patch(0x20f13a0, 0xd2800000)    # mov x0, #0   # __ZN23AppleKeyStoreUserClient14externalMethodEjP25IOExternalMethodArgumentsP24IOExternalMethodDispatchP8OSObjectPv
patch(0x20f13a0+4, 0xD65F03C0)      # ret
...
patch(0x20f15d8, 0xd503201f)    # nop  # patched call IOLog instruction         # __ZN23AppleKeyStoreUserClient14externalMethodEjP25IOExternalMethodArgumentsP24IOExternalMethodDispatchP8OSObjectPv
# panic(cpu 0 caller 0xfffffff043769a54): "REQUIRE fail: nullptr != xartSEPSlaveEP() @ IOReturn AppleSEPManager::_powerChangeNotificat...
patch(0x213a43c, 0xd2800000)    # mov x0, #0    # __ZN15AppleSEPManager31_powerChangeNotificationHandlerEPvjP9IOServiceS0_m
patch(0x213a43c+4, 0xD65F03C0)  # ret
...
patch(0x213e1fc, 0xd503201f)  # nop     # __ZN15AppleSEPManager14_setPowerStateEPm
patch(0x213d194, 0xd503201f)  # nop     # __ZN15AppleSEPManager20_notifyOSActiveGatedEv
# patch panic
'''
...
Memory ID: 0x1
'''
patch(0x213e22c, 0xd503201f)    # nop   # __ZN15AppleSEPManager14_setPowerStateEPm
patch(0x213e7c4, 0xd503201f)    # nop   # xref str "AppleSEP:WARNING: Unable to reseed XNU PRNG, attempt %d/%d\n"
...
patch(0x20bfd50,   RET_VAL)     # __ZN22AppleCredentialManager34sepManagerMatchedThreadCallHandlerEv
patch(0x20bfd50+4, RET)

patch(0x20c0434,   RET_VAL)     # __ZN22AppleCredentialManager20callPlatformFunctionEPK8OSSymbolbPvS3_S3_S3_
patch(0x20c0434+4, RET)
patch(0x20c04bc,   RET_VAL)     # cmdContextV2
patch(0x20c04bc+4, RET)
patch(0x20c0548,   RET_VAL)     # cmdContextV3
patch(0x20c0548+4, RET)

patch(0x20c0824,   RET_VAL)     # performCommandGated
patch(0x20c0824+4, RET)
patch(0x20c1314,   RET_VAL)     # _performKernelControl
patch(0x20c1314+4, RET)
patch(0x20c16d4,   RET_VAL)     # _performCommand
patch(0x20c16d4+4, RET)
patch(0x20c1900,   RET_VAL)     # processSCRDResponsePayload
patch(0x20c1900+4, RET)
patch(0x20c1b30,   RET_VAL)     # scheduleDblClickDeferredAck
patch(0x20c1b30+4, RET)
patch(0x20c1c54,   RET_VAL)     # updateAnalytics
patch(0x20c1c54+4, RET)
patch(0x20c1dbc,   RET_VAL)     # performSCRDInitialization
patch(0x20c1dbc+4, RET)

patch(0x20c2084,   RET_VAL)     # sendSEPCommand
patch(0x20c2084+4, RET)
patch(0x20c2b00,   RET_VAL)     # __ZN22AppleCredentialManager19_setPropertiesGatedEP8OSObject
...
patch(0x20c36e8+4, RET)
patch(0x20c3bac,   RET_VAL)     # handleSEPMessage
patch(0x20c3bac+4, RET)
patch(0x20c3e98,   RET_VAL)     # __ZN20AppleRepairSEPDriver17readFromSEPBufferEPvm
patch(0x20c3e98+4, RET)

patch(0x20c3ffc,   RET_VAL)     # writeToSEPBuffer
patch(0x20c3ffc+4, RET)
patch(0x20c43a8,   RET_VAL)     # sendSEPMessage
patch(0x20c43a8+4, RET)
patch(0x20c45e4,   RET_VAL)     # __ZN22AppleCredentialManager14clearSEPBufferEP13IOSlaveMemorym
patch(0x20c45e4+4, RET)
patch(0x20c4784,   RET_VAL)     # getSEPEndpoint
patch(0x20c4784+4, RET)
patch(0x20c53d0,   RET_VAL)     # powerOffActionGated
